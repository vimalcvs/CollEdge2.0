package com.vimalcvs.colledge.honours.baheconomic;
...
import com.vimalcvs.colledge.honours.baheconomic.sem1.BAEconomic_Hons_SEM1;
import com.vimalcvs.colledge.honours.baheconomic.sem2.BAEconomic_Hons_SEM2;
import com.vimalcvs.colledge.honours.baheconomic.sem3.BAEconomic_Hons_SEM3;
import com.vimalcvs.colledge.honours.baheconomic.sem4.BAEconomic_Hons_SEM4;
import com.vimalcvs.colledge.honours.baheconomic.sem5.BAEconomic_Hons_SEM5;
import com.vimalcvs.colledge.honours.baheconomic.sem6.BAEconomic_Hons_SEM6;

public class BAEconomic_Hons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEconomic_Hons.this,BAEconomic_Hons_SEM1.class);
        ...
        cardView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEconomic_Hons.this, BAEconomic_Hons_SEM2.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        ...
        cardView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEconomic_Hons.this, BAEconomic_Hons_SEM3.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        cardView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEconomic_Hons.this, BAEconomic_Hons_SEM4.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
        ...
        cardView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEconomic_Hons.this, BAEconomic_Hons_SEM5.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        ...
        cardView6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEconomic_Hons.this, BAEconomic_Hons_SEM6.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });

package com.vimalcvs.colledge.honours.bahindi;
...
import com.vimalcvs.colledge.honours.bahindi.sem1.BAHindi_SEM1;
import com.vimalcvs.colledge.honours.bahindi.sem2.BAHindi_SEM2;
import com.vimalcvs.colledge.honours.bahindi.sem3.BAHindi_SEM3;
import com.vimalcvs.colledge.honours.bahindi.sem4.BAHindi_SEM4;
import com.vimalcvs.colledge.honours.bahindi.sem5.BAHindi_SEM5;
import com.vimalcvs.colledge.honours.bahindi.sem6.BAHindi_SEM6;

/** * Created by VimalCVS on 22/08/18. */

public class BAHindi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(BAHindi.this,BAHindi_SEM1.class);
        ...
        cardView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAHindi.this, BAHindi_SEM2.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        ...
        cardView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAHindi.this, BAHindi_SEM3.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        cardView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAHindi.this, BAHindi_SEM4.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
        ...
        cardView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAHindi.this, BAHindi_SEM5.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        ...
        cardView6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAHindi.this, BAHindi_SEM6.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });

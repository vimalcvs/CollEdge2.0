package com.vimalcvs.colledge.honours.bahenglish;
...
import com.vimalcvs.colledge.honours.bahenglish.sem1.BAEnglish_Hons_SEM1;
import com.vimalcvs.colledge.honours.bahenglish.sem2.BAEnglish_Hons_SEM2;
import com.vimalcvs.colledge.honours.bahenglish.sem3.BAEnglish_Hons_SEM3;
import com.vimalcvs.colledge.honours.bahenglish.sem4.BAEnglish_Hons_SEM4;
import com.vimalcvs.colledge.honours.bahenglish.sem5.BAEnglish_Hons_SEM5;
import com.vimalcvs.colledge.honours.bahenglish.sem6.BAEnglish_Hons_SEM6;


public class BAEnglish_Hons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEnglish_Hons.this,BAEnglish_Hons_SEM1.class);
        ...
        cardView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEnglish_Hons.this, BAEnglish_Hons_SEM2.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        ...
        cardView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEnglish_Hons.this, BAEnglish_Hons_SEM3.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        cardView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEnglish_Hons.this, BAEnglish_Hons_SEM4.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
        ...
        cardView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEnglish_Hons.this, BAEnglish_Hons_SEM5.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        ...
        cardView6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BAEnglish_Hons.this, BAEnglish_Hons_SEM6.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });

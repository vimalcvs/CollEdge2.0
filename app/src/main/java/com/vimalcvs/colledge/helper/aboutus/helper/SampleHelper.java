package com.vimalcvs.colledge.helper.aboutus.helper;
...
public class SampleHelper implements View.OnClickListener {
    ...
    public void loadAbout() {
        ...
        AboutBuilder builder = AboutBuilder.with(activity)
                ...
                .setSubTitle("Android developer, Engineering student, Freelancer and an open source enthusiast.")
                .setLinksColumnsCount(4)
                .setBrief("I tried my best to create this app user friendly. I hope you enjoy it.")

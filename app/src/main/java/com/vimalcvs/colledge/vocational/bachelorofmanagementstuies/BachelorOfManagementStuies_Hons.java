...
public class BachelorOfManagementStuies_Hons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //BMS mei maal kam hai islie toast lagaya hai
        Toast.makeText(this,"BMS is underdeveloped right now. If you want to contribute notes or question papers, kindly reach out to us via contribute section.",Toast.LENGTH_LONG).show();

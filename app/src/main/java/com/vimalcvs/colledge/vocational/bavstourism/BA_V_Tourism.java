package com.vimalcvs.colledge.vocational.bavstourism;
...
import com.vimalcvs.colledge.vocational.bavstourism.sem1.BA_V_Tourism_SEM1;
import com.vimalcvs.colledge.vocational.bavstourism.sem2.BA_V_Tourism_SEM2;
import com.vimalcvs.colledge.vocational.bavstourism.sem3.BA_V_Tourism_SEM3;
import com.vimalcvs.colledge.vocational.bavstourism.sem4.BA_V_Tourism_SEM4;
import com.vimalcvs.colledge.vocational.bavstourism.sem5.BA_V_Tourism_SEM5;
import com.vimalcvs.colledge.vocational.bavstourism.sem6.BA_V_Tourism_SEM6;
...
public class  BA_V_Tourism extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(BA_V_Tourism.this,BA_V_Tourism_SEM1.class);
        ...
        cardView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BA_V_Tourism.this, BA_V_Tourism_SEM2.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        ...
        cardView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BA_V_Tourism.this, BA_V_Tourism_SEM3.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        cardView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BA_V_Tourism.this,  BA_V_Tourism_SEM4.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
        ...
        cardView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BA_V_Tourism.this, BA_V_Tourism_SEM5.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
        ...
        cardView6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(BA_V_Tourism.this, BA_V_Tourism_SEM6.class);
                startActivity(myIntent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            }
        });
